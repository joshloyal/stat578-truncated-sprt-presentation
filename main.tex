...
Let $X_1, X_2, \dots  \iidsim N(\theta, 1)$. We are interested in testing $H_0: \theta \leq -\delta$ vs. $H_1: \theta \geq \delta$.

\end{frame}

\begin{frame}
\frametitle{Example: Gaussian Distribution}
The effect of $c_1 = c_2$:

\begin{figure}
\centering
\begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\textwidth]{images/mixing_c01}
\end{subfigure}
\begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\textwidth]{images/mixing_c05}
\end{subfigure}
\begin{subfigure}{0.49\textwidth}
    \includegraphics[width=\textwidth]{images/mixing_c09}
\end{subfigure}
\end{figure}
